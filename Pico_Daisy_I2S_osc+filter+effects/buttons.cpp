...
int button_counter(int button_count, int count){
...
void button_event(u8 this_b)
{
    switch(this_b)
    {
        case BUTTON_ONE:
        {
            osc_counter = button_counter(osc_counter, 3);
        }
        break;

        case BUTTON_TWO:
        {
            filter_counter = button_counter(filter_counter, 2);
            // Do something for button two
        }
        break;
        case BUTTON_THREE:
        {
            effect_counter = button_counter(effect_counter, 3);
        }
        break;
    }
}
